...
$route['admin/siswa/cetak_pdf'] = 'SiswaController/cetak_pdf';
...
$route['admin/editPetugas/(:any)'] = 'UserController/editPetugas/$1';
$route['admin/siswa/cetak_excel'] = 'SiswaController/cetak_excel';
